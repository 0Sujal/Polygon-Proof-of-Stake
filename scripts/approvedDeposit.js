...
async function main() {
  ...
  const nft = await NFT.attach("0x0f03a12540a17169C06871263D54E7b971d94E9B");
  ...
  // Test balanceOf
  const balance = await nft.balanceOf('0xbcEDFdE753a3511075B67faB5979992A893FBeb4');

  // Print the balance of the wallet
  console.log(
    "SujaL wallet balance",
    '0xbcEDFdE753a3511075B67faB5979992A893FBeb4',
    "is: ",
    balance.toString()
  );
}
